...
class MiFormulario(QWidget):
    ...
    def boton1_callback(self):
        ...
        es presionado. En esta caso, realiza el cambio en label2 y el status
        bar mediate la emisión de una señal en la cual se envía el texto
        correspondiente.
        """
    ...
    def load_status_bar(self, signal):
        """
        Este método recibirá una señal desde el MainWindow que permitirá
        hacer cambios en el status bar desde el widget central.
        """
