...
def generate_connections(path = "Archivos/",file_names = ["airports"]):
	for name in file_names:
		...
		dict_countries = {}
		with open("Archivos/{}.csv".format(name),"r") as file_in:
			#le quito el header
			file_in.readline()
		...
		for country in all_countries:
			...
			with open("Archivos/random_{}.csv".format(name), "a") as file:
